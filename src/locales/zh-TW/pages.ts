export default {
  ...
  // 個人設定頁面
  'profile.settings.title': '個人設定',
  'profile.settings.nickname': '暱稱',
  'profile.settings.nickname.required': '請輸入暱稱',
  'profile.settings.nickname.placeholder': '請輸入您的暱稱',
  'profile.settings.bio': '個人簡介',
  'profile.settings.bio.required': '請輸入個人簡介',
  'profile.settings.bio.placeholder': '請簡要介紹一下自己',
  'profile.settings.address': '城市地址',
  'profile.settings.province': '省份',
  'profile.settings.province.required': '請選擇省份',
  'profile.settings.province.placeholder': '請選擇省份',
  'profile.settings.city': '城市',
  'profile.settings.city.required': '請選擇城市',
  'profile.settings.city.placeholder': '請選擇城市',
  'profile.settings.district': '縣市',
  'profile.settings.district.required': '請選擇縣市',
  'profile.settings.district.placeholder': '請選擇縣市',
  'profile.settings.detailAddress': '詳細地址',
  'profile.settings.detailAddress.required': '請輸入詳細地址',
  'profile.settings.detailAddress.placeholder': '請輸入詳細地址',
  'profile.settings.phone': '聯絡電話',
  'profile.settings.phone.required': '請輸入聯絡電話',
  'profile.settings.phone.format': '請輸入正確的手機號碼',
  'profile.settings.phone.placeholder': '請輸入您的手機號碼',
  'profile.settings.email': '郵箱地址',
  'profile.settings.email.required': '請輸入郵箱地址',
  'profile.settings.email.format': '請輸入正確的郵箱地址',
  'profile.settings.email.placeholder': '請輸入您的郵箱地址',
  'profile.settings.submit': '儲存',
};
