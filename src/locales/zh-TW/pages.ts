export default {
  ...
  // 個人設置頁面
  'profile.settings.title': '個人設置',
  'profile.settings.basicInfo': '基本資訊',
  'profile.settings.addressInfo': '地址資訊',
  'profile.settings.contactInfo': '聯繫方式',
  'profile.settings.nickname': '暱稱',
  'profile.settings.nickname.placeholder': '請輸入暱稱',
  'profile.settings.nickname.required': '暱稱是必填項',
  'profile.settings.nickname.max': '暱稱最多20個字元',
  'profile.settings.bio': '個人簡介',
  'profile.settings.bio.placeholder': '請輸入個人簡介',
  'profile.settings.bio.max': '個人簡介最多200個字元',
  'profile.settings.province': '省份',
  'profile.settings.province.placeholder': '請選擇省份',
  'profile.settings.province.required': '省份是必填項',
  'profile.settings.city': '城市',
  'profile.settings.city.placeholder': '請選擇城市',
  'profile.settings.city.required': '城市是必填項',
  'profile.settings.district': '縣市',
  'profile.settings.district.placeholder': '請選擇縣市',
  'profile.settings.district.required': '縣市是必填項',
  'profile.settings.detailAddress': '詳細地址',
  'profile.settings.detailAddress.placeholder': '請輸入詳細地址',
  'profile.settings.detailAddress.required': '詳細地址是必填項',
  'profile.settings.detailAddress.max': '詳細地址最多200個字元',
  'profile.settings.phone': '聯繫電話',
  'profile.settings.phone.placeholder': '請輸入聯繫電話',
  'profile.settings.phone.required': '聯繫電話是必填項',
  'profile.settings.phone.format': '請輸入正確的手機號碼格式',
  'profile.settings.email': '郵箱地址',
  'profile.settings.email.placeholder': '請輸入郵箱地址',
  'profile.settings.email.required': '郵箱地址是必填項',
  'profile.settings.email.format': '請輸入正確的郵箱地址格式',
  'profile.settings.submit': '儲存設定',
  'profile.settings.submit.success': '儲存成功',
  'profile.settings.submit.error': '儲存失敗，請重試',
};
