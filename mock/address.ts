...
// 获取省份列表
async function getProvinces(_req: Request, res: Response) {
  await waitTime(300);
  res.send({
    success: true,
    data: mockProvinces,
...
export default {
  'GET /api/address/provinces': getProvinces,
  'GET /api/address/cities': getCities,
  'GET /api/address/districts': getDistricts,
};
